...
| Registro de ciclo biológico (lotes: perfil + memoria + módulos, campaña como etiqueta; fechas gobernadas por el humano: inicio elegible, cosecha con override, retiro de módulo sin cierre) | **MCP terra-domain** (tabla `lotes`, `open/close_batch`, `remove_module_from_batch`, hashes en código, ADR-0021/0024/0026; un módulo solo aloja un lote activo) | Markdown del agente como registro primario |
